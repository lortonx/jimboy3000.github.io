   ...
   '<textarea id="Userscripttexture5" class="form-control ps-container ps-theme-default" rows="14" cols="100" spellcheck="false" align="middle" style="display: none;"></textarea>'+
	...
	'<button id="userscriptBtn5" type="button" class="btn btn-block btn-info" data-toggle="button" aria-pressed="false" autocomplete="off" style="margin-top: 2px; display: none;"><i class="fa fa-code"></i>Load Script from Textarea</button>'+
		...
		'<br>'+
											...
											'<input id="UserscriptA" class="form-control" placeholder="User Script 1 .js URL (Leave this empty if script not imported from URL)" value="" style="margin-top: 2px; display: block;" " data-toggle="tooltip" data-placement="top" data-original-title="Url of Raw Github, or other Raw Script, starting with http://... or https://..." >' +	
											'<input id="UserscriptB" class="form-control" placeholder="User Script 2 .js URL (Leave this empty if script not imported from URL)" value="" style="margin-top: 2px; display: none"  " data-toggle="tooltip" data-placement="top" data-original-title="Url of Raw Github, or other Raw Script, starting with http://... or https://..." >' +		
											'<input id="UserscriptC" class="form-control" placeholder="User Script 3 .js URL (Leave this empty if script not imported from URL)" value="" style="margin-top: 2px; display: none;" " data-toggle="tooltip" data-placement="top" data-original-title="Url of Raw Github, or other Raw Script, starting with http://... or https://..." >' +		
											'<input id="UserscriptD" class="form-control" placeholder="User Script 4 .js URL (Leave this empty if script not imported from URL)" value="" style="margin-top: 2px; display: none;" " data-toggle="tooltip" data-placement="top" data-original-title="Url of Raw Github, or other Raw Script, starting with http://... or https://..." >' +		
											'<input id="UserscriptE" class="form-control" placeholder="User Script 5 .js URL (Leave this empty if script not imported from URL)" value="" style="margin-top: 2px; display: none;" "data-toggle="tooltip" data-placement="top" data-original-title="Url of Raw Github, or other Raw Script, starting with http://... or https://..." >' +												
											'</div>' +	
