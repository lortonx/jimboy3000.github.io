// ==UserScript==
// @name         Legend Express Agar.io Extension PIXI
// @namespace    Legend Express Agario Mod PIXI
// @version      1.8
...
switch (mode) {
    ...
    case 'delta':
        ...
        break;
    case 'neo': 
        modwebsite = 'https://legendmod.ml/LMexpress/LMexpressWebGL.html?' + version;
        Htmlscript(modwebsite);
		setTimeout(function() {		
	...
	break;	
    case 'mobile': 
        modwebsite = 'https://legendmod.ml/LMexpress/LMexpressWebGL.html';
        Htmlscript(modwebsite);
		setTimeout(function() {		
    ...
    case 'legendmod': default:
        modwebsite = 'https://jimboy3000.github.io/LMexpress/LMexpressWebGL.html'
        Htmlscript(modwebsite);
        break;
}
