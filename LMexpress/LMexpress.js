/**************
 * Legend express v1.85 by Jimboy3100   email:jimboy3100@hotmail.com
 *************/
...
*/
    ...
    $("#leaderboard-hud").append('<div id="leaderboard-menu" style="pointer-events: auto;">' +
        ...
        '<div id="dropDown3" class="hud" style="position: absolute; pointer-events: auto; width: 33%; left: 67px; padding: 0px; border-radius: 0px;">' +
