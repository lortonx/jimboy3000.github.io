/**************
 * Legend express v0.062k by Jimboy3100   email:jimboy3100@hotmail.com
 *************/
...
function universalchat() {
    ...
    my.ogarMinimapUpdate = function() {
        ...
        if (cfg.user_show) {
			...
			user_txt += '</div> <span class="hud-main-color ogicon-users"></span> : <span id="top5-total-players" class="top5-mass-color">' + count2 + '</span>'; 
