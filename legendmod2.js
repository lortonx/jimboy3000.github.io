...
/*	
	...
	$(".menu-tabs").children().last().after('<li class="legend-tab" style="width: 14.27%; height: 100%;" data-toggle="tooltip" data-title="Tools" data-placement="top"><a style="height: 100%;" onclick=legendtab();  href="javascript:void(0);" class="fa fa-cogs"></a></li>');
...
function legendtab(){
$('#main-menu').children('div').hide(); $('.menu-tabs').children('li').removeClass('active'); $('.menu-tabs').children('li').children('a').removeClass('active'); $('#legend').fadeIn(); $(this).addClass('active'); 
$(this).parent().addClass('active'); 
//$('#helloContainer').attr('style','transform: translate(-50%, 0%) scale(1); top: 207px;')
}
