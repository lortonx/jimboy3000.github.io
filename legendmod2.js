...
/*	
    ...
    $("#main-menu").children().last().before('<div id="legend" class="menu-panel"><div class="agario-panel legend-panel">' + //<h5 class="menu-main-color">Main Tools</h5>
