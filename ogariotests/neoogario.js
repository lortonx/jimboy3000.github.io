(function (window, ogario, $) {
    ...
    var INTERFACE_HELPER = {
        ...
        'loadThemeSettings': function () {
            ...
            for (var _0xac9e75 in PRESET) {
                if (PRESET.hasOwnProperty(_0xac9e75)) {
                    ...
                    if (ogario.hasOwnProperty(_0xac9e75)) {
                        ogario[_0xac9e75] = PRESET[_0xac9e75];
                    }
                }
            }
        },
        ...
        'addColorBox': function (_0x3d2f8e, _0x12abd8, _0x21ad3b) {
            ...
            if (_0x21ad3b) {
                ...
                $(_0x3d2f8e + ' .' + _0x12abd8 + '-picker').colorpicker({
                    ...
                    if (ogario.hasOwnProperty(_0x12abd8)) {
                        ogario[_0x12abd8] = PRESET[_0x12abd8];
                    }
                    _0x35e01d[_0x21ad3b]();
                });
            } else {
        ...
        'addRgbaColorBox': function (_0x94377a, _0x123f8d, _0x383d2e) {
            ...
            if (_0x383d2e) {
                ...
                $(_0x94377a + ' .' + _0x123f8d + '-picker').colorpicker({
                    ...
                    if (ogario.hasOwnProperty(_0x123f8d)) {
                        ogario[_0x123f8d] = PRESET[_0x123f8d];
                    }
                    _0x1e800d[_0x383d2e]();
                });
            } else {
        ...
        'addSliderBox': function (_0x3c1f56, _0x373a4e, _0x367b30, _0x1c7b3a, _0x101151, _0x1e3a7f) {
            ...
            if (_0x1e3a7f) {
                ...
                $('#' + _0x373a4e + '-slider').on('input', function () {
                    ...
                    if (ogario.hasOwnProperty(_0x373a4e)) {
                        ogario[_0x373a4e] = _0x335824;
                    }
                    _0x1aed11[_0x1e3a7f]();
                });
            } else {
        ...
        'setFont': function (_0x1d96bc, _0x211b42) {
            ...
            if (ogario.hasOwnProperty(_0x1d96bc + 'Family')) {
                ogario[_0x1d96bc + 'Family'] = PRESET[_0x1d96bc + 'Family'];
            }
            if (ogario.hasOwnProperty(_0x1d96bc + 'Weight')) {
                ogario[_0x1d96bc + 'Weight'] = PRESET[_0x1d96bc + 'Weight'];
            }
        },
        ...
        'setThemeMenu': function () {
            ...
            this.addSliderBox('#theme-hud', 'hudScale', 0.02, 0x2, 0.01, 'setHudScale');
        ...
        'changePreset': function (_0x5c7470, _0x34e70f) {
            ...
            for (var _0x27fd34 in _0x5c7470) {
                if (_0x5c7470.hasOwnProperty(_0x27fd34) && PRESET.hasOwnProperty(_0x27fd34)) {
                    ...
                    if (ogario.hasOwnProperty(_0x27fd34)) {
                        ogario[_0x27fd34] = PRESET[_0x27fd34];
                    }
    ...
    var MapChatUiCtrl = window.bb = {
        ...
        'setShowSplitRange': function () {
            ...
            ogario.splitRange = CLIENT_SETTINGS.splitRange;
        },
        'setShowSplitInd': function () {
            ...
            ogario.splitRange = CLIENT_SETTINGS.splitRange;
            ogario.oppRings = CLIENT_SETTINGS.oppRings;
        },
        ...
        'setShowOppColors': function () {
            ...
            ogario.oppColors = CLIENT_SETTINGS.oppColors;
        },
        ...
        'setTransparentSkins': function () {
            ...
            ogario.transparentSkins = CLIENT_SETTINGS.transparentSkins;
        },
        ...
        'resetZoom': function (_0x4fbac4) {
            if (_0x4fbac4) {
                ogario.zoomResetValue = 0x1;
                ogario.zoomValue = 0x1;
            } else {
                ogario.zoomResetValue = 0x0;
            }
        },
        'setZoom': function (_0x15e430) {
            ogario.zoomValue = _0x15e430;
        },
        ...
        'tryResp': function () {
            if (ogario.play || this.retryResp == 0x14) {
                this.retryResp = 0x0;
                return;
            }
            this.retryResp++;
        ...
        'displayStats': function () {
            ...
            var str = '';
            if (ogario.play) {
                if (CLIENT_SETTINGS.showStatsMass && ogario.playerMass) {
                    //str += i18n.mass + ': ' + CLIENT2.playerMass + ' | ';
                    str += i18n.mass+": "+ogario.playerMass+" "+~~(ogario.playerMass/4)+" "+~~(ogario.playerMass/16)+" | ";
                }
                if (ogario.playerScore) {
                    str += i18n.score + ': ' + ogario.playerScore;
                }
                if (CLIENT_SETTINGS.showStatsSTE && ogario.STE) {
                    str += ' | STE: ' + ogario.STE;
                }
                if (CLIENT_SETTINGS.showStatsN16 && ogario.playerSplitCells) {
                    var substr = ogario.playerSplitCells===16?'<span style="background:green">'+ogario.playerSplitCells+'/16</span>':ogario.playerSplitCells+"/16"
                    str += " | "+substr;
                }
        ...
        'loadSettings': function () {
            ...
            for (var _0x4454c7 in CLIENT_SETTINGS) {
                if (CLIENT_SETTINGS.hasOwnProperty(_0x4454c7)) {
                    ...
                    if (ogario.hasOwnProperty(_0x4454c7)) {
                        ogario[_0x4454c7] = CLIENT_SETTINGS[_0x4454c7];
                    }
                }
            }
        },
        ...
        'setSettings': function (_0x55e321, _0x3c1bf9) {
            if (CLIENT_SETTINGS.hasOwnProperty(_0x55e321) && _0x3c1bf9 !== null) {
                ...
                if (ogario.hasOwnProperty(_0x55e321)) {
                    ogario[_0x55e321] = _0x3c1bf9;
                }
                switch (_0x55e321) {
                case 'autoResp':
                    this.setAutoResp();
        ...
        'loadProfiles': function () {
            ...
            currentProfile.nick = _0x420606[this.selectedProfile].nick;
            currentProfile.clanTag = _0x420606[this.selectedProfile].clanTag;
            currentProfile.skinURL = _0x420606[this.selectedProfile].skinURL;
            currentProfile.color = _0x420606[this.selectedProfile].color;
        },
        ...
        'addSliderBox': function (_0x56f505, _0x1c15d3, _0x50c451, _0x189ec6, _0x2b7adb, _0x829dbf) {
            ...
            if (_0x829dbf) {
                $('#' + _0x1c15d3 + '-slider').on('input', function () {
                    ...
                    if (ogario.hasOwnProperty(_0x1c15d3)) {
                        ogario[_0x1c15d3] = _0x227cea;
                    }
                    _0x2f7b75[_0x829dbf]();
        ...
        'setUI': function () {
            ...
            $(document).on('change', '#gamemode', function () {
                ...
                _0x54ce18.gameMode = ogario.gameMode = _0x2e80aa;
                _0x54ce18.setQuest();
            });
            ...
            $(document).on('change', '.js-switch-vanilla', function () {
                ...
                if (typeof _0x54ce18[_0x32f315] !== 'undefined') {
                    ...
                    if (_0x32f315 === 'noSkins') {
                        ogario.showCustomSkins = !_0x54ce18.noSkins;
                    }
        ...
        'getDefaultSettings': function () {
            ...
            $('#nick').val(currentProfile.nick).blur();
        ...
        'onPlayerSpawn': function () {
            ...
            if (ogario.playerColor) {
                ...
                this.cacheCustomSkin(currentProfile.nick, ogario.playerColor, currentProfile.skinURL);
                return;
            }
            var _0x523eef = this;
            setTimeout(function () {
        ...
        'onPlayerDeath': function () {
            ...
            ogario.playerMass = 0x0;
            ogario.playerScore = 0x0;
            ogario.playerSplitCells = 0x0;
            this.showMenu(0x12c);
            this.sendPlayerDeath();
        ...
        'setPlayerSettings': function () {
            ...
            currentProfile.nick = _0x18184f;
            currentProfile.clanTag = _0x536407.trim();
            currentProfile.skinURL = this.checkSkinURL(_0x1eda49.trim());
            if (_0xd0ceb3.length == 0x7) {
                currentProfile.color = _0xd0ceb3;
            }
            if (currentProfile.clanTag.length > 0x0) {
                ogario.clanTag = currentProfile.clanTag;
            }
            _0x420606[this.selectedProfile].nick = currentProfile.nick;
            _0x420606[this.selectedProfile].clanTag = currentProfile.clanTag;
            _0x420606[this.selectedProfile].skinURL = currentProfile.skinURL;
            _0x420606[this.selectedProfile].color = currentProfile.color;
        ...
        'calculateMapSector': function (_0x3ff952, _0x577897, _0x554651 = false) {
            ...
            var _0x25108b = _0x554651 ? ogario.mapOffsetX + ogario.mapOffset : ogario.mapOffset;
            var _0xf6281e = _0x554651 ? ogario.mapOffsetY + ogario.mapOffset : ogario.mapOffset;
            var _0x5569c9 = Math.floor((_0x577897 + _0xf6281e) / (ogario.mapSize / PRESET.sectorsY));
            var _0x5396e0 = Math.floor((_0x3ff952 + _0x25108b) / (ogario.mapSize / PRESET.sectorsX));
        ...
        'updateDeathLocations': function (_0x2978e6, _0x4c9eca) {
            ...
            this.deathLocations.push({
                'x': _0x2978e6 + ogario.mapOffsetX,
                'y': _0x4c9eca + ogario.mapOffsetY
            });
        ...
        'drawMiniMap': function () {
            ...
            var _0xf0bd01 = _0x474681 / ogario.mapSize;
            var _0xd252ff = ogario.mapOffsetX + ogario.mapOffset;
            var _0x29f645 = ogario.mapOffsetY + ogario.mapOffset;
            ...
            if (CLIENT_SETTINGS.showMiniMapGuides) {
                var _0x5bc965 = Math.round((ogario.playerX + _0xd252ff) * _0xf0bd01);
                var _0x1c4bc1 = Math.round((ogario.playerY + _0x29f645) * _0xf0bd01);
            ...
            this.miniMapCtx.beginPath();
            this.miniMapCtx.arc((ogario.playerX + _0xd252ff) * _0xf0bd01, (ogario.playerY + _0x29f645) * _0xf0bd01, PRESET.miniMapMyCellSize, 0x0, this.pi2, false);
            ...
            if (this.teamPlayers.length) {
                for (var _0x1b9508 = 0x0; _0x1b9508 < this.teamPlayers.length; _0x1b9508++) {
                    this.teamPlayers[_0x1b9508].drawPosition(this.miniMapCtx, ogario.mapOffset, _0xf0bd01, this.privateMiniMap, this.targetID);
                }
            }
            if (this.deathLocations.length > 0x0) {
                var _0x5bc965 = Math.round((this.deathLocations[this.lastDeath].x + ogario.mapOffset) * _0xf0bd01);
                var _0x1c4bc1 = Math.round((this.deathLocations[this.lastDeath].y + ogario.mapOffset) * _0xf0bd01);
        ...
        'drawMiniMapSectors': function (_0x122736, _0x28392e, _0x86b59e, _0x3a5a9e, _0x56e2c4) {
            ...
            WORLD.drawSectors(_0x48e2a1, ogario.mapOffsetFixed, _0x122736, _0x28392e, 0.5, _0x56e2c4, _0x86b59e - 0.5, _0x3a5a9e - 9.5, PRESET.miniMapSectorsColor, PRESET.miniMapSectorsColor, 0x1, false);
        },
        'resetMiniMapSectors': function () {
            this.miniMapSectors = null;
        },
        'drawSelectedCell': function (_0x201880) {
            if (ogario.play && ogario.playerSplitCells > 0x1 && (CLIENT_SETTINGS.splitRange || CLIENT_SETTINGS.oppColors || CLIENT_SETTINGS.oppRings || CLIENT_SETTINGS.showStatsSTE)) {
        ...
        'drawCellInfo': function (_0x585cdf, _0x225cb3, _0x2a6026, _0x2a7a56, _0x10df88, _0x317dfe, _0x414514, _0x578fef, _0x33e71b, _0x57a881, _0x32ca26, _0x2a5b7f) {
            ...
            _0x585cdf.globalAlpha = ogario.globalAlpha;
            ...
            _0x5524a0.setDrawingScale(ogario.viewScale, PRESET.namesScale, PRESET.massScale, PRESET.virMassScale, PRESET.strokeScale);
        ...
        'setVirusStrokeColor': function (_0x48027f) {
            if (ogario.play && ogario.playerMaxMass != 0x0) {
                var _0x5d874e = Math.floor(_0x48027f * _0x48027f / 0x64);
                var _0x12cda6 = _0x5d874e / (this.selectBiggestCell ? ogario.playerMaxMass : ogario.playerMinMass);
                if (_0x12cda6 > 0.76) {
                    return '#FFDC00';
                }
                return '#C80000';
        ...
        'setAutoHideCellInfo': function (_0x1726dd) {
            if (_0x1726dd <= 0x28 || ogario.viewScale < 0.5 && _0x1726dd < 0x226 && _0x1726dd < 0x19 / ogario.viewScale) {
                return true;
            }
            return false;
        },
        ...
        'sendPlayerNick': function () {
            this.sendPlayerData(0xa, 'lastSentNick', currentProfile.nick);
        },
        'sendPlayerClanTag': function () {
            this.sendPlayerData(0xb, 'lastSentClanTag', currentProfile.clanTag);
        },
        'sendPlayerSkinURL': function () {
            this.sendPlayerData(0xc, 'lastSentSkinURL', currentProfile.skinURL);
        },
        'sendPlayerCustomColor': function () {
            this.sendPlayerData(0xd, 'lastSentCustomColor', currentProfile.color);
        },
        'sendPlayerColor': function () {
            if (this.isSocketOpen() && ogario.playerColor) {
                this.sendBuffer(this.strToBuff(0xe, ogario.playerColor));
            }
        },
        ...
        'sendPlayerUpdate': function () {
            if (this.isSocketOpen() && ogario.play && this.playerID && ogario.playerColor) {
                ...
                var _0x4c07ef = 0x29;
                _0x4c07ef += currentProfile.nick.length * 0x2;
                _0x4c07ef += currentProfile.skinURL.length * 0x2;
                var _0x2ae1bf = this.createView(_0x4c07ef);
                _0x2ae1bf.setUint8(0x0, 0x14);
                _0x2ae1bf.setUint32(0x1, this.playerID, true);
                var _0x55a306 = 0x5;
                _0x34eb83(currentProfile.nick);
                _0x34eb83(currentProfile.skinURL);
                _0x34eb83(currentProfile.color);
                _0x34eb83(ogario.playerColor);
        ...
        'sendPlayerPosition': function () {
            if (this.isSocketOpen() && ogario.play && this.playerID) {
                ...
                if (typeof ogario.playerMass !== 'undefined') {
                    _0x19923e.setUint32(0xd, ogario.playerMass, true);
                } else {
        ...
        'sendChatMessage': function (_0x1fc3d8, _0x4125cc) {
            if (Date.now() - this.lastMessageSentTime < 0x1f4 || _0x4125cc.length == 0x0 || currentProfile.nick.length == 0x0) {
                return;
            }
            if (this.isSocketOpen()) {
                var _0x4125cc = currentProfile.nick + ': ' + _0x4125cc;
        ...
        'updateTarget': function (_0x2d7b26, _0x56b897, _0x5c24e8, _0x3376b1, _0x8493cf, _0x4b83c3) {
            ogario.setTargetPosition(_0x5c24e8, _0x3376b1);
            ...
            var _0xc3d78b = i18n.targetDistance + ': <span class="hud-main-color">' + ogario.targetDistance + ' . + _0x34d2c8 + </span>';
            if (ogario.play) {
                _0xc3d78b += ' | ' + i18n.targetMass + ': <span class="hud-main-color">' + this.shortMassFormat(_0x8493cf + ogario.playerMass) + '</span>';
            }
    ...
    function cellObj(id, x, y, mass, colorHEX, isFood, isVirus, isPlayerCell, shortMass, virMassShots) {
        ...
        this.setDrawingScale = function () {
            this.setScale(ogario.viewScale, PRESET.namesScale, PRESET.massScale, PRESET.virMassScale, PRESET.strokeScale);
            this.setFontSize();
            this.setStrokeSize();
            this.margin = 0x0;
        };
        ...
        this.draw = function (ctx, _0x53dced) {
            ...
            }else if (CLIENT_SETTINGS.jellyPhisycs && this.isVirus) {
                ctx.lineJoin = "miter"
                var pointCount = 120;
    ...
    var CLIENT = window.aa = {
        ...
        'connect': function (_0x5a6416) {
            var fakeserv = null
            if(_0x5a6416.indexOf('vrrx7n')>-1) fakeserv = 'wss://wss1.raga.pw:1505'
            ...
            this.leaderboard = [];
            this.ws = _0x5a6416;
            this.socket = new WebSocket(fakeserv||_0x5a6416);
            this.socket.binaryType = 'arraybuffer';
            this.socket.onopen = function () {
                _0x1d750d.onOpen();
            };
        ...
        'onOpen': function (_0x57e3c8) {
            ...
            _0x37ab5a.setUint32(0x1, 22, true); //версия протокола
          ...
          var sendSpawn = function() {
            ...
            /*grecaptcha.ready(function() {
                ...
                //grecaptcha.execute('6LcEt74UAAAAAIc_T6dWpsRufGCvvau5Fd7_G1tY', {action: 'play'}).then(function(token) {
                    ...
                    var nick = window.unescape(window.encodeURIComponent(self.playerNick));
                    var data = [0];
        ...
        'sendAccessToken': function (_0x2c3c67, _0x4596a3, _0x5c3d81) {
            ...
            var clientVerLen = this.clientVersionString.length;
            var packet = [_0x5c3d81, 0x8, 0x1, 0x12];
            this.writeUint32(packet, _0x18182a + clientVerLen + 0x17);
            packet.push(0x8, 0xa, 0x52);
            this.writeUint32(packet, _0x18182a + clientVerLen + 0x12);
            packet.push(0x8, _0x4596a3, 0x12, clientVerLen + 0x8, 0x8, 0x5, 0x12, clientVerLen);
            for (var _0x1bfdb6 = 0x0; _0x1bfdb6 < clientVerLen; _0x1bfdb6++) {
                packet.push(this.clientVersionString.charCodeAt(_0x1bfdb6));
            }
            packet.push(0x18, 0x0, 0x20, 0x0, 0x1a);
            this.writeUint32(packet, _0x18182a + 0x3);
            packet.push(0xa);
            this.writeUint32(packet, _0x18182a);
            for (_0x1bfdb6 = 0x0; _0x1bfdb6 < _0x18182a; _0x1bfdb6++) {
                packet.push(_0x2c3c67.charCodeAt(_0x1bfdb6));
            }
            
            window.testobjects2 = packet = new Uint8Array(packet);
            var _0x70d8a6 = new DataView(packet.buffer);
        ...
        'handleMessage': function (packet) {
            ...
            case 102:
						...
						window.testobjects=packet;
						//лconsole.log("packet:", s);
        ...
        'handleLeaderboard': function () {
            ...
            for (var _0x1207f1 = 0x0; _0x1207f1 < this.leaderboard.length; _0x1207f1++) {
                ...
                if (this.leaderboard[_0x1207f1].id === 'isPlayer') {
                    ...
                    if (currentProfile.clanTag.length && this.leaderboard[_0x1207f1].nick.indexOf(currentProfile.clanTag) == 0x0) {
        ...
        'recalculatePlayerMass': function () {
            ...
            if (CLIENT_SETTINGS.showStatsSTE) {
                ...
                if (_0x3ee74b > 0x23) {
                    this.STE = ~~(_0x3ee74b * (_0x3ee74b < 1000 ? 0.35 : 0.38));
                } else {
                    this.STE = null;
                }
            }
        ...
        'compareCells': function () {
            ...
            if (CLIENT_SETTINGS.oppColors || CLIENT_SETTINGS.oppRings || CLIENT_SETTINGS.splitRange) {
                ...
                for (var _0x329cf4 = 0x0; _0x329cf4 < this.cells.length; _0x329cf4++) {
                    ...
                    var _0x4ab66f = _0x9c08f9 < 1000 ? 0.35 : 0.38;
    ...
    function _0x5865b8() {
        ogario.getWS = function (_0x42552c) {
            MapChatUiCtrl.getWS(_0x42552c);
        };
        ogario.displayLeaderboard = function () {
            MapChatUiCtrl.displayLeaderboard(ogario.leaderboardHTML);
        };
        ogario.drawGrid = function (_0x6a6a35) {
            MapChatUiCtrl.drawGrid(_0x6a6a35);
        };
        ogario.customDraw = function (_0x8653b4) {
            MapChatUiCtrl.customDraw(_0x8653b4);
        };
        ogario.drawCellInfo = function (_0x61b881, _0x5bc6be, _0x5c8eb8, _0x147a68, _0x3acf4c, _0x7ff13c, _0x530758, _0x2828c5, _0x15edbc, _0x49941f, _0x3642d7, _0x1f5366) {
        ...
        ogario.getCustomSkin = function (_0xf074ae, _0x160e64) {
            return MapChatUiCtrl.getCustomSkin(_0xf074ae, _0x160e64);
        };
        ogario.setVirusColor = function (_0x296704) {
            return MapChatUiCtrl.setVirusColor(_0x296704);
        };
        ogario.setVirusStrokeColor = function (_0x47ff7f) {
            return MapChatUiCtrl.setVirusStrokeColor(_0x47ff7f);
        };
        ogario.setOppColor = function (_0x40cb00, _0x5c8f63) {
    ...
    function _0xbd31d4() {
        if (document.getElementById('canvas')) {
            ...
            _0x21a527.addEventListener('mousemove', function (_0x48e6fc) {
                if (ogario.play && ogario.cursorTracking && ogario.setCursorPosition) {
                    ogario.clientX = _0x48e6fc.clientX;
                    ogario.clientY = _0x48e6fc.clientY;
                    ogario.setCursorPosition();
                }
            }, false);
            return;
        }
    ...
    function TRANSFORM_WIEW() {
        ...
        if (_0x2c212f > 0x0) {
            ogario.menuHeight = _0x2c212f;
        } else {
            _0x2c212f = ogario.menuHeight || 0x26a;
        }
        ...
        ogario.innerW = _0x14935a;
        ogario.innerH = _0x47f930;
    }
