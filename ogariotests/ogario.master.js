...
function makeUpperCaseAfterUnderline(str) {
    return str.replace(/_\s*([a-z])/g, function(d,e) { return "_"+e.toUpperCase() });
}
        ...
        var LM = {
            ...
            'setClientVersion': function(t, e) {
                ...
                if (window.disableIntegrity != true) { //
                    ...
                    console.log('[Legend mod Express] Versions: client:', t, e, "x-proto:", this.xsupportprotoversion, "protocol:", this.protocolVersion, "ConfigVersion", "v" + window.getLatestconfigVersion, "ConfigId", window.getLatestID);
                } //
                else { //
