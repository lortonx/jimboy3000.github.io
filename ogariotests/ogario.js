            ...
            t.drawImage(nickImg, ~~this.x - ~~(w / 2), ~~this.y - this.margin, w, h);
                ...
                this.draw = function(style, canCreateDiscussions) {				
                    if (!(M.hideSmallBots && this.size <= 36)) {
                        ...
                        if (v.customSkins && M.showCustomSkins && (node = ogarminimapdrawer.getCustomSkin(this.targetNick, this.color), node = ogarminimapdrawer.getCustomSkin2(this.targetNick, this.color)) && 
						...
						node2.includes(".mp4") && console.log(node2),
