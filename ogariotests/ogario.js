        ...
        this.draw = function(style, cellMoved) { //this function draws each cell/virus/food 1 time only
            ...
            if (defaultmapsettings.jellyPhisycs && this.points.length) {
				...
				if (!node){
					...
					if (defaultmapsettings.cellContours || defaultmapsettings.transparentCells || defaultmapsettings.transparentSkins || ((this.isPlayerCell || this.playerCellsMulti) && defaultmapsettings.myTransparentSkin)){ //this is the normal function
