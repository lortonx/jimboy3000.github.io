          ...
          this["sendMessage"](raw_basefont);
            ...
            'handleLeaderboard': function() {				
                ...
                for (var t = '', e = '', i = 0; i < this['leaderboard'].length && window.leaderboardlimit != i; i++) {
                    var s = '<span>';
                    'isPlayer' === this['leaderboard'][i]['id'] ? s = '<span class=\"me\">' : 
					ogarcopythelb['clanTag'].length && 0 == 
					teammatenicks.includes(this['leaderboard'][i]['nick']) 
					&& (s = '<span class=\"teammate\">'),
					t += s + (i + 1) + '. ' + ogarminimapdrawer['escapeHTML'](this['leaderboard'][i]['nick']) + '</span>';
                }				
/*                for (var t = '', e = '', i = 0; i < this['leaderboard'].length && window.leaderboardlimit != i; i++) {
                    var s = '<span>';
