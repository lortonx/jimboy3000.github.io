                ...
                this.drawTxt = function(customTxt) {
                    return this.createCanvas(),
                        this.redraw && (this.redraw = false,
                            ...
                            customTxt && this.stroke && this.txtCtx.strokeText(customTxt, this.strokeWidth, ~~(this.fontSize - this.margin)),
							!customTxt && this.stroke && this.txtCtx.strokeText(this.txt, this.strokeWidth, ~~(this.fontSize + this.margin * 0.5)),
                            customTxt && this.txtCtx.fillText(customTxt, this.strokeWidth, ~~(this.fontSize - this.margin)),
        ...
        this.drawNick = function (t) {
			...
			if( window.legendmod.playerCellIDs.length>1 && window.playerCellsId[this.id].mergeTime && window.playerCellsId[this.id].mergeTime > 1 ){
                var customTxt = Math.round(window.playerCellsId[this.id].mergeTime);
                        ...
                        var width2 = ~~(data.width2 / this.scale);
                        var height2 = ~~(data.height2 / this.scale);	
                        var textureY = this.margin === 0 ? ~~(this.y + height2) : ~~this.y - 2 * this.margin;
                        if (width > 1 && height > 1) {
							try {
                            context.drawImage(data2, ~~(this.x - width2 / 2), textureY, width2, height2);
							} catch (e) {}			
                        }							
