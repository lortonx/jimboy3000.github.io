    ...
    var application = window.application = {
        ...
        */
        ...
        setMenu() {
			...
			'<div id="exp-bar" class="agario-panel"><span class="ogicon-user"></span><div class="agario-exp-bar progress"><span class="progress-bar-text">LM level: </span><div class="progress-bar progress-bar-striped2" style="width: 0%;"><div class="progress-bar-star2"></div></div></div></div>'+
