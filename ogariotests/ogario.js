...
*/
    ...
    var LM = {
        ...
        onOpen() {
            ...
            if (!LM.ws.includes("imsolo.pro") || window.protocol6) view.setUint32(1, this.protocolVersion, true); //
			...
			if (!LM.ws.includes("imsolo.pro") || window.protocol6) view.setUint32(1, this.clientVersion, true); //
