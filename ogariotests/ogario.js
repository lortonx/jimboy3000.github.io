...
//					this.camY += (M.viewY - this.camY) / 2) :
            ...
            ogario11Hotkeys = {
                ...
                'hk-comm18': {
                    'label': c[`comm18`],
                    'defaultKey': 'Reversed Tricksplit',
                    'keyDown': function() {
                ...
                'hk-comm20': {
                    'label': c[`comm20`],
                    'defaultKey': 'Reversed Canonsplit',
                    'keyDown': function() {
