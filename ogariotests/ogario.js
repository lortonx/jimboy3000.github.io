...
*/
            ...
            'handleLeaderboard': function() {
                ...
                for (var o = 0; o < this.ghostCells.length && o != i; o++) e += '<span class=\"lb-data\" style="pointer-events: auto;">', e += '<span class=\"top5-mass-color\">[' + ogarminimapdrawer['shortMassFormat'](this.ghostCells[o].mass) + ']</span>', e += '<span class=\"hud-main-color\">[' + ogarminimapdrawer['calculateMapSector'](this.ghostCells[o]['x'], this.ghostCells[o]['y']) + ']</span>', e += '</span>';
