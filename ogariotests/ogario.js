        ...
        this.draw = function(style, canCreateDiscussions) {
            ...
            if (defaultmapsettings.customSkins && LM.showCustomSkins) {
                ...
                if (node) {
					...
					//style.drawImage(cimgSpecialSkinEffectsSunGlasses, this.x - 5/7 * y, this.y - 1/2 * y, y * 2, y * 2);  	
					style.drawImage(cimgSpecialSkinEffectsSunGlasses, this.x -  window.xx1 * y, this.y - window.xx2 * y, y * window.xx3, y * window.xx4);  	
