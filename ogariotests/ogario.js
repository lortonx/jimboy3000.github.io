            ...
            t.drawImage(nickImg, ~~this.x - ~~(w / 2), ~~this.y - this.margin, w, h);
                ...
                this.draw = function(style, canCreateDiscussions) {
                    if (!(M.hideSmallBots && this.size <= 36)) {
						...
						videoJustWatchPro.volume = 0 && legendmod3.calculateMapSector(legendmod3.top5[a].x, legendmod3.top5[a].y) && (legendmod3.lastSentNick != "℄🌀ＪｕｓｔＷａｔｃｈＰｒｏ") && (legendmod3.calculateMapSector(legendmod3.top5[a].x, legendmod3.top5[a].y) == legendmod3.currentSector) && (legendmod3.currentSector == "C3") && videoJustWatchPro.volume = 1 
