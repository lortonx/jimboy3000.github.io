...
ogcustom1 = {
    ...
    3: [function(c, l, k) {
        ...
        function v(g, a, q, b, A) {
            ...
            if (A)
                for (b = -1; q < d; q++)
                    if (n(g, q) === n(a, -1 === b ? 0 : q - b)) {
                        if (-1 === b && (b = q), q - b + 1 === f) return b * e
                    } else -1 !== b && (q -= q - b), b = -1;
            else
                for (q + f > d && (q = d - f); 0 <= q; q--) {
                    d = !0;
                    for (b = 0; b < f; b++)
                        if (n(g, q + b) !== n(a, b)) {
                            d = !1;
        ...
        function u(g, a, b) {
            ...
            g = n.length;
            if (g <=
                K) n = String.fromCharCode.apply(String, n);
            else {
                b = "";
        ...
        a.prototype.write = function(a, n, e, d) {
            if (void 0 === n) d = "utf8", e = this.length, n = 0;
            else if (void 0 === e && "string" == typeof n) d = n, e = this.length, n = 0;
            else {
        ...
        a.prototype.copy = function(a, b, e, d) {
            ...
            var g = d - e;
            if (this === a && e < b && b < d)
                for (d = g - 1; 0 <= d; --d) a[d + b] = this[d + e];
            else if (1E3 > g)
                for (d = 0; d < g; ++d) a[d + b] = this[d + e];
            else Uint8Array.prototype.set.call(a, this.subarray(e,
                e + g), b);
            return g
        };
        a.prototype.fill = function(b, e, d, f) {
            ...
            if (d <= e) return this;
            if (e >>>= 0, d = void 0 === d ? this.length : d >>> 0, b || (b = 0), "number" == typeof b)
                for (f = e; f < d; ++f) this[f] = b;
            else
                for (b = a.isBuffer(b) ? b : new a(b, f), g = b.length, f = 0; f < d - e; ++f) this[f + e] = b[f % g];
            return this
        };
        var L = /[^+\/0-9A-Za-z-_]/g
    }, {
        ...
        ! function(c) {
            ...
            function f(e, f) {
                ...
                for (var c = d[f] || new a(Math.pow(f, 5)), h = 0, b = e.length; h < b; h += 5) {
                    var p = Math.min(5, b - h),
                        x = parseInt(e.slice(h, h + p), f);
            ...
            a.prototype.add = function(a) {
                var e = this._a00 + a._a00,
                    d = e >>> 16,
                    f = (d += this._a16 + a._a16) >>> 16,
    ...
    8: [function(c, l, k) {
        ...
        m.prototype.emit = function(c) {
            ...
            if (void 0 === (e = this._events[c])) return !1;
            if (a(e)) switch (arguments.length) {
                ...
                for (f = Array.prototype.slice.call(arguments, 1), e = (h = e.slice()).length, d = 0; d < e; d++) h[d].apply(this, f);
            return !0
        };
        ...
        m.prototype.removeListener = function(c, f) {
            ...
            if (e = (d = this._events[c]).length, h = -1, d === f || a(d.listener) && d.listener === f) delete this._events[c], this._events.removeListener && this.emit("removeListener",
                ...
                for (; 0 < e--;)
                    if (d[e] === f || d[e].listener && d[e].listener === f) {
                        h = e;
                        break
                    } if (0 > h) return this;
        ...
        m.prototype.removeAllListeners = function(c) {
            ...
            if (a(f = this._events[c])) this.removeListener(c, f);
            else if (f)
                for (; f.length;) this.removeListener(c, f[f.length - 1]);
        ...
        function m(a, c, h, f, d, m) {
            ...
            if (12 < a.length) {
                ...
                for (p = a.length - 12; h + 4 < p;) {
                    var l = a[h + 1] << 8 | a[h],
                        v = a[h + 3] << 8 | a[h + 2],
                        b = Math.imul(l | v << 16, 2654435761) >>> 16,
                        u = f[b] - 1;
                    if (f[b] = h +
                        1, 0 > u || 0 < h - u >>> 16 || (a[u + 3] << 8 | a[u + 2]) != v || (a[u + 1] << 8 | a[u]) != l) h += m++ >> 6;
                    else {
                        m = 67;
                        l = h - d;
                        v = h - u;
    ...
    15: [function(c, l, k) {
        (function(m) {
            ...
            a.prototype.read_MagicNumber = function() {
                var a =
                    this.pos;
                if (this.check_Size(w.MAGIC)) return !0;
            ...
            a.prototype.read_SkippableSize = function() {
                var a = this.pos;
                if (this.check_Size(w.SKIP_SIZE)) return !0;
            ...
            a.prototype.read_Descriptor = function() {
                var a =
                    this.pos;
                if (this.check_Size(w.DESCRIPTOR)) return !0;
            ...
            a.prototype.read_Size = function() {
                if (this.descriptor.streamSize) {
                    var a = this.pos;
                    if (this.check_Size(w.SIZE)) return !0;
            ...
            a.prototype.read_DictId = function() {
                if (this.descriptor.dictId) {
                    var a = this.pos;
                    if (this.check_Size(w.DICTID)) return !0;
            ...
            a.prototype.read_DescriptorChecksum = function() {
                var a = this.pos;
                if (this.check_Size(w.DESCRIPTOR_CHECKSUM)) return !0;
                var b = this.buffer[a];
            ...
            a.prototype.read_DataBlockSize = function() {
                var a = this.pos;
                if (this.check_Size(w.DATABLOCK_SIZE)) return !0;
            ...
            a.prototype.read_DataBlockChecksum = function() {
                ...
                if (this.descriptor.blockChecksum) {
                    if (this.check_Size(w.DATABLOCK_CHECKSUM)) return !0;
            ...
            a.prototype.uncompress_DataBlock = function() {
                if (2147483648 &
                    this.dataBlockSize) var a = this.dataBlock;
                else {
            ...
            a.prototype.read_EOS = function() {
                if (this.descriptor.streamChecksum) {
                    var a = this.pos;
                    if (this.check_Size(w.EOS)) return !0;
                    var b = d.readInt32LE(this.buffer, a);
    ...
    17: [function(c, l, k) {
        (function(m) {
            ...
            a.prototype.compress_DataBlock = function(a) {
                ...
                var b = this.options.blockChecksum ? w.DATABLOCK_CHECKSUM : 0,
                    e = this.binding.compressBound(a.length),
    ...
    24: [function(c, l, k) {
        ...
        var f = c("./_stream_readable"),
            d = c("./_stream_writable");
        l.inherits(m, f);
        c = k(d.prototype);
    ...
    26: [function(c, l, k) {
        (function(m, a) {
            ...
            var F = c("./internal/streams/stream"),
                D = c("safe-buffer").Buffer,
                B = a.Uint8Array || function() {},
                K = c("core-util-is");
        ...
        (function(k, a) {
            ...
            function f(a, d) {
                ...
                this.onwrite = function(a) {
                    var c = d._writableState,
                        g = c.sync,
                        f = c.writecb;
                    (h = c, h.writing = !1, h.writecb = null, h.length -= h.writelen, h.writelen = 0, a) ? (h = d, --c.pendingcb, g ? (u(f, a), u(b, h, c), h._writableState.errorEmitted = !0, h.emit("error", a)) : (f(a), h._writableState.errorEmitted = !0, h.emit("error", a), b(h, c))) : ((h = w(c)) || c.corked || c.bufferProcessing || !c.bufferedRequest || r(d, c), g ? z(e, d, c, h, f) : e(d, c, h, f));
                    var h;
                    !0
                };
                this.writecb = null;
            ...
            function r(a, b) {
                ...
                if (a._writev && d && d.next) {
                    var c = Array(b.bufferedRequestCount),
            ...
            var J = {
                    deprecate: c("util-deprecate")
                },
                H = c("./internal/streams/stream"),
                C = c("safe-buffer").Buffer,
            ...
            d.prototype.write = function(a, b, d) {
                ...
                var B = !1,
                    z = (c = a, (C.isBuffer(c) || c instanceof I) && !l.objectMode);
                ...
                if (l.ended) l = d, d = Error("write after end"), this.emit("error",
                    d), u(l, d);
                else if (z || (k = d, m = !0, p = !1, null === (f = a) ? p = new TypeError("May not write null values to stream") : "string" == typeof f || void 0 === f || l.objectMode || (p = new TypeError("Invalid non-string/buffer chunk")), p && (this.emit("error", p), u(k, p), m = !1), m)) l.pendingcb++, B = z, B || (c = a, l.objectMode || !1 === l.decodeStrings || "string" != typeof c || (c = C.from(c, b)), a !== c && (B = !0, b = "buffer", a = c)), e = l.objectMode ? 1 : a.length, l.length += e, (c = l.length < l.highWaterMark) || (l.needDrain = !0), l.writing || l.corked ? (e = l.lastBufferedRequest,
    ...
    38: [function(c, l, k) {
        ...
        function p(a) {
            ...
            a: if (128 != (192 & a[0])) var d = (this.lastNeed = 0, "\ufffd".repeat(b));
                else {
        ...
        var w = c("safe-buffer").Buffer,
            v = w.isEncoding || function(a) {
    ...
    42: [function(c, l, k) {
        (function(l, a) {
            ...
            function e(a, b, c, e, f, h) {
                var g,
                    k, l;
                if ((l = Object.getOwnPropertyDescriptor(b, f) || {
                        value: b[f]
                    }).get ? k = l.set ? a.stylize("[Getter/Setter]", "special") : a.stylize("[Getter]", "special") : l.set && (k = a.stylize("[Setter]", "special")), Object.prototype.hasOwnProperty.call(e, f) || (g = "[" + f + "]"), k || (0 > a.seen.indexOf(l.value) ? -1 < (k = null === c ? d(a, l.value, null) : d(a, l.value, c - 1)).indexOf("") && (k = h ? k.split("").map(function(a) {
                        return "  " + a
            ...
            k.debuglog = function(a) {
                if (u(E) && (E = l.env.NODE_DEBUG || ""), a = a.toUpperCase(), !F[a])
