...
//                   'targetNotSet': 'Brak celu',
        ...
        u = {
            ...
            v = {
				...
				'virusSound': 'https://jimboy3100.github.io/sounds/sound-gunshot.mp3',
...
/*            'drawTeammatesInd': function(t, e, i, s) {
            ...
            'setvirusSound': function() {
                this['virusSound'] = this['setSound'](v['virusSound']);
            },			
            'setSound': function(t) {
...
*/
        ...
        this.moveCell = function () {
			...
			if(this.isVirus){
				...
				if(v.virusSound && this.lastMass && this.mass < this.lastMass) {ogarminimapdrawer.playSound(v['virusSound'])}
