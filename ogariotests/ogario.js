		...
		n[r].comm25=c.comm25; n[r].comm26=c.comm26; n[r].comm27=c.comm27; n[r].comm28=c.comm28; n[r].comm29=c.comm29; n[r].comm30=c.comm30;		*/
                    ...
                    */
                    ...
                    'loadProfiles': function() {
                        if (null !== e.localStorage.getItem('ogarioPlayerProfiles')) {
                            ...
                            if (ogario1PlayerProfiles.length == 10) {
                                var t = 10;
                                for (; t < 15; t++) {
                    ...
                    'setMainButtons': function() {
                        ...
                        s(document).on('click', '.btn-play, .btn-play-guest', function() {
                            ...
                            t['skipServerData'] = true, t['joinParty'](), t['onJoin']();
                    ...
                    'cacheSkin': function(t) {
                        ...
                        if (0 != this['cacheQueue'].length) {
                            ...
                            if (e) {
                                ...
                                s['beginPath'](), s.arc(256, 256, 256, 0, 2 * Math['PI'], false), s['clip'](), s['drawImage'](this['customSkinsCache'][e], 0, 0, 512, 512), this['customSkinsCache'][e + '_cached'] = new Image(), this['customSkinsCache'][e + '_cached'].src = i.toDataURL(), i = null, this['cacheSkin'](this['customSkinsCache']);
                            }
                        }
                    },
                    ...
                    'drawMiniMap': function() {
                        if (i['mapOffsetFixed']) {
                            var t = g['miniMapWidth'],
                                ...
                                o = t - 18,
                                a = e + 9.5;
                            this['miniMap'] ? this['miniMapCtx']['clearRect'](0, 0, t, s) : (this['miniMap'] = document.getElementById('minimap'), this['miniMapCtx'] = this['miniMap']['getContext']('2d'), this['miniMapCtx']['ogarioCtx'] = true, this['miniMap']['width'] = t, this['miniMap']['height'] = s), this['miniMap']['width'] != t && (this['miniMap']['width'] = t, this['miniMap']['height'] = s);
                            var n = o / i['mapSize'],
                            ...
                            if (this['drawSelectedCell'](this['miniMapCtx']), this['currentSector'] = this['calculateMapSector'](i['playerX'], i['playerY'], true), this['miniMapCtx']['globalAlpha'] = 1, this['miniMapCtx']['font'] = g['miniMapFontWeight'] + ' ' + (e - 4) + 'px ' + g['miniMapFontFamily'], this['miniMapCtx']['fillStyle'] = g['miniMapSectorColor'], this['miniMapCtx']['fillText'](this['currentSector'], 10, e), this['miniMapSectors'] || this['drawMiniMapSectors'](g['sectorsX'], g['sectorsY'], o, s, a), this['miniMapCtx']['save'](), this['miniMapCtx']['translate'](9.5, a), ':battleroyale' === this['gameMode'] && ogarfooddrawer && ogarfooddrawer['drawBattleAreaOnMinimap'](this['miniMapCtx'], o, o, n, r, l), v['showMiniMapGhostCells']) {
                                ...
                                for (var c = 0; c < h.length; c++)
                                    if (!h[c]['inView']) {
                                        var u = ~~((h[c]['x'] + r) * n),
                                            d = ~~((h[c]['y'] + l) * n);
                                        this['miniMapCtx']['moveTo'](u, d), this['miniMapCtx'].arc(u, d, ~~(h[c]['size'] * n), 0, this.pi2, false);
                    ...
                    'drawSelectedCell': function(t) {
                        if (i.play && i["playerSplitCells"] > 1 && (v["splitRange"] || v["oppColors"] || v["oppRings"] || v["showStatsSTE"])) {
                            t["fillStyle"] = "#FFFFFF";
                            t["globalAlpha"] = this["selectBiggestCell"] ? 0.6 : 0.3;
                            t["beginPath"]();
                            t.arc(48, 15, 6, 0, this.pi2, false);
                            t["closePath"]();
                            t.fill();
                            t["globalAlpha"] = this["selectBiggestCell"] ? 0.3 : 0.6;
                            t["beginPath"]();
                            t.arc(60, 15, 4, 0, this.pi2, false);
                            t["closePath"]();
                            t.fill();
                        }
                    },
                    ...
                    'connect': function() {
                        ...
                        this.socket["onopen"] = function() {
                            ...
                            var view = t.createView(3);
                            view.setUint8(0, 0);
                            view.setUint16(1, 401, true);
                            t["sendBuffer"](view);
                            t["sendPartyData"]();
                        }, this.socket["onmessage"] = function(store) {
                            t["handleMessage"](store);
                        }, this.socket["onclose"] = function(contextReference) {
                            t["flushData"]();
                            console.log("[Legend mod Express] Socket close", contextReference);
                        }, this.socket["onerror"] = function(contextReference) {
                            t["flushData"]();
                            console.log("[Legend mod Express] Socket error", contextReference);
                        };
                    },
                    ...
                    'sendPlayerUpdate': function() {
                        if (this["isSocketOpen"]() && i.play && this["playerID"] && i["playerColor"]) {
                            var t = function(t) {
                                var i = 0;
                                for (; i < t.length; i++) {
                                    s.setUint16(o, t.charCodeAt(i), true);
                                    o = o + 2;
                                }
                                s.setUint16(o, 0, true);
                                o = o + 2;
                            };
                            var e = 41;
                            e = e + 2 * ogarcopythelb["nick"].length;
                            e = e + 2 * ogarcopythelb["skinURL"].length;
                    ...
                    'sendPlayerPosition': function() {
                        if (this['isSocketOpen']() && i.play && this['playerID']) {
                            ...
                            t.setUint8(0, 30), t.setUint32(1, this['playerID'], true), t['setInt32'](5, this['getPlayerX'](), true), t['setInt32'](9, this['getPlayerY'](), true), void 0 !== i['playerMass'] ? t.setUint32(13, i['playerMass'], true) : t.setUint32(13, this['playerMass'], true), this['sendBuffer'](t);
                        }
                    },
                    ...
                    'readChatMessage': function(t) {
                        ...
                        'setTargetStatus': function(t) {
                            switch (t) {
                                case 0:
                                    this['targetStatus'] = 0, this['targetID'] = 0, this['targetNick'] = '', this['targetSkinURL'] = '', this['targeting'] = false, i['targeting'] = false, this['privateMiniMap'] = false, s('#target-skin, #target-nick, #target-summary').hide(), s('#target-status').show().text('[' + h['targetNotSet'] + ']'), s('#target-panel-hud a').removeClass('active');
                                    break;
                                case 1:
                    ...
                    function irenderfromagario() {
                        this["txt"] = "", this["txtCanvas"] = null, this["txtCtx"] = null, this["color"] = "#FFFFFF", this["stroke"] = false, this["strokeWidth"] = 2, this["strokeColor"] = "#000000", this["font"] = "700 16px Ubuntu", this["fontFamily"] = "Ubuntu", this["fontWeight"] = 700, this["fontSize"] = 16, this["margin"] = 3, this["scale"] = 1, this["quality"] = 1, this["measuredWidth"] = 0, this["redraw"] = false, this["remeasure"] = false, this["setTxt"] = function(be) {
                            if (this["txt"] !== be) {
                                this["txt"] = be;
                                this["redraw"] = true;
                                this["remeasure"] = true;
                            ...
                            if (this["stroke"] && this["strokeWidth"] != width) {
                            ...
                            if (this["fontSize"] != value) {
                                this["fontSize"] = value;
                                this["margin"] = ~~(0.2 * value);
                                this.setFont();
                                this["redraw"] = true;
                            }
                        }, this["setScale"] = function(tmp) {
                            if (this["scale"] != tmp) {
                                this["scale"] = tmp;
                                this["redraw"] = true;
                            }
                        ...
                        }, this["setDrawing"] = function(mmCoreSplitViewBlock, mmaPushNotificationsComponent, value, mmaFrontpagePriority, isBgroundImg, mmaModFeedbackAutomSyncedEvent) {
                            this["setColor"](mmCoreSplitViewBlock);
                            this["setFontFamily"](mmaPushNotificationsComponent);
                            ...
                            return this["createCanvas"](), this["redraw"] && (this["redraw"] = false, this["txtCanvas"]["width"] = this["measureWidth"](), this["txtCanvas"]["height"] = this["fontSize"] + this["margin"] * 2, this["txtCtx"]["font"] = this["font"], this["txtCtx"]["globalAlpha"] = 1, this["txtCtx"]["lineWidth"] = this["strokeWidth"], this["txtCtx"]["strokeStyle"] = this["strokeColor"], this["txtCtx"]["fillStyle"] = this["color"], this["stroke"] && this["txtCtx"]["strokeText"](this["txt"], this["strokeWidth"],
                                ~~(this["fontSize"] + this["margin"] * 0.5)), this["txtCtx"]["fillText"](this["txt"], this["strokeWidth"], ~~(this["fontSize"] + this["margin"] * 0.5))), this["txtCanvas"];
                        };
                    }
				...
				*/
                            ...
                            'drawDangerArea': function(t, e, i, s, o, a, n, r, l, h) {
                                M['battleRoyale']['radius'] == M['battleRoyale']['maxRadius'] || s <= 0 || (t['save'](), t['globalAlpha'] = h, t['fillStyle'] = l, t['fillRect'](o, a, n, r), t['globalCompositeOperation'] = 'destination-out', t['globalAlpha'] = 1, t['beginPath'](), t.arc(e, i, s, 0, this.pi2, false), t.fill(), t['restore']());
                            },
                                ...
                                if (v['showGhostCells']) {
                                    ...
                                    for (var e = 0; e < t.length; e++)
                                        if (!t[e]['inView']) {
                                            var i = t[e]['x'],
                                                s = t[e]['y'];
                                            this['ctx']['moveTo'](i, s), this['ctx'].arc(i, s, t[e]['size'], 0, this.pi2, false);
                    ...
                    o = t('buffer')['Buffer'],
                    a = t('lz4'),
                    '/ogario' === e.location['pathname'] && ogarjoiner('/' + e['location']['hash']),
                    e['onresize'] = function() {
