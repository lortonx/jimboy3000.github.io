        ...
        this.draw = function(style, canCreateDiscussions) {
            ...
            if (defaultmapsettings.customSkins && LM.showCustomSkins) {
                ...
                if (node) {
					...
					style.drawImage(cimgSpecialSkinEffectsLegendHeroes, this.x - 1/6 * y, this.y - 5.3/4 * y, y/3, y/9);
					...
					style.drawImage(cimgSpecialSkinEffectsLegendHeroes2, this.x - 1/6 * y, this.y - 5.3/4 * y, y/3, y/6);
