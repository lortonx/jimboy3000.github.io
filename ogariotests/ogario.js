            ...
            if (defaultmapsettings.customSkins && LM.showCustomSkins) {
                ...
                if (node) {
					...
					*/	
					...
					//style.drawImage(cimgSpecialSkinEffectsShiro, this.x - 0.333 * y, this.y - 1.325 * y, y / 1.5, y / 6);  	
					style.drawImage(cimgSpecialSkinEffectsShiro, this.x - window.xx1 * y, this.y - window.xx2 * y, y/window.xx3, y/window.xx4);	
					if (!window.xx1) window.xx1 = 0.333
					if (!window.xx2) window.xx2 = 1.325
					if (!window.xx3) window.xx3 = 1.5
					if (!window.xx4) window.xx4 = 6					
