...
//			this.historyY = [];
        ...
        this.moveCell = function () {
			...
			else if(!v.optimizedMass && !this.isVirus && this.isPlayerCell && window.playerCellsId && window.playerCellsId[this.id] && window.playerCellsId[this.id].mergeTime && window.playerCellsId[this.id].mergeTime > 1 ){
