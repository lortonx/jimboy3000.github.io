          ...
          if (v["showTop5"]) {
            ...
            for (; entityType < PL$29; entityType++) {
              ...
              if (!(entityType >= v["limTP"])) {
                pix_color = pix_color + ('<li id="player"><span id="pos-skin" style="background-color: ' + this["top5"][entityType]["color"] + '; width: 30px; height:30px; display: inline-block;"><img style="margin-left 0px; margin-top 0px; width: 26px; height:26px; display: inline-block;"  src = ' + (this["top5"][entityType]["skin"] ? this["top5"][entityType]["skin"] : "https://jimboy3100.github.io/banners/icon32croped.ico.gif") + '" alt=""> ' + 
