...
!function() {
  ...
  window[_0xb217("0x0")] = {play:!1, spectate:!1, gameMode:"", clanTag:"", playerColor:null, playerX:0, playerY:0, playerCells:[], playerCellsMass:[], playerMass:0, playerMinMass:0, playerMaxMass:0, playerBestMass:null, STE:null, mapSize:14142, mapOffset:7071, mapOffsetX:0, mapOffsetY:0, mapOffsetFixed:!1, mapMinX:-7071, mapMinY:-7071, mapMaxX:7071, mapMaxY:7071, zoomValue:1, zoomResetValue:0, zoomSpeedValue:.9, viewScale:1, canvasScale:1, animation:140, innerW:0, innerH:0, cursorX:0, cursorY:0, 
  clientX:0, clientY:0, targetX:0, targetY:0, targetDistance:0, menuHeight:618, leaderboardHTML:"", leaderboardIndex:1, foodCache:[], virusesCache:[], biggerSTECellsCache:[], biggerCellsCache:[], smallerCellsCache:[], STECellsCache:[], virusColor:"#999999", virusStrokeColor:_0xb217("0x1"), gloabalAlpha:1, cellsAlpha:.9, skinsAlpha:.7, virusAlpha:.6, virusStrokeSize:14, autoZoom:!1, autoHideFood:!1, autoHideFoodOnZoom:!1, vanillaSkins:!1, customSkins:!0, myTransparentSkin:!1, myCustomColor:!1, transparentCells:!1, 
  transparentViruses:!0, transparentSkins:!1, rainbowFood:!1, oppColors:!1, oppRings:!1, virColors:!1, splitRange:!1, virusesRange:!1, cursorTracking:!1, showStatsSTE:!1, showFood:!0, foodIsHidden:!1, showCustomSkins:!0, selectBiggestCell:!0, hideSmallBots:!1, pause:!1, targeting:!1, getWS:null, displayLeaderboard:null, drawGrid:null, customDraw:null, drawCellInfo:null, setOppColor:null, setVirusColor:null, setVirusStrokeColor:null, getString:null, getCustomSkin:null, setMapCoords:function(a, c, 
  b, d, e, f) {
    ...
    a -= this[_0xb217("0x2")];
    c -= this[_0xb217("0x4")];
    var b = ((a - this[_0xb217("0xb")]) * this[_0xb217("0xa")] + this[_0xb217("0x8")] / 2) * this.canvasScale, d = ((c - this[_0xb217("0xf")]) * this[_0xb217("0xa")] + this[_0xb217("0xe")] / 2) * this.canvasScale;
    ...
    if (0 != this[_0xb217("0x15")][_0xb217("0x16")]) {
      if ((this.playerMass > this[_0xb217("0x17")] || !this[_0xb217("0x17")]) && (this[_0xb217("0x17")] = this[_0xb217("0x18")]), this[_0xb217("0x19")] || this[_0xb217("0x1a")] || this[_0xb217("0x1b")] || this[_0xb217("0x1c")] || this[_0xb217("0x1d")]) {
        ...
        for (var a = 1; a < this[_0xb217("0x15")][_0xb217("0x16")]; a++) {
          this[_0xb217("0x15")][a] < this[_0xb217("0x1e")] ? this[_0xb217("0x1e")] = this.playerCellsMass[a] : this[_0xb217("0x15")][a] > this[_0xb217("0x1f")] && (this.playerMaxMass = this[_0xb217("0x15")][a]);
        }
      }
    ...
    var d = Math.floor(b * b / 100), e = this[_0xb217("0x20")] ? this[_0xb217("0x1f")] : this.playerMinMass;
    d /= e;
    return 2.5 > d ? 1.25 > d ? 1.25 > d && .75 < d ? void 0 : d > (1E3 > e ? .35 : .38) ? void this[_0xb217("0x24")][_0xb217("0x25")]({x:a, y:c, size:b}) : void this[_0xb217("0x26")][_0xb217("0x25")]({x:a, y:c, size:b}) : void this[_0xb217("0x27")][_0xb217("0x25")]({x:a, y:c, size:b}) : void this[_0xb217("0x28")][_0xb217("0x25")]({x:a, y:c, size:b});
  }};
  ...
  CanvasRenderingContext2D[_0xb217("0x29")].fillText = function() {
    ...
    if (_0xb217("0x31") !== window[_0xb217("0x0")][_0xb217("0x32")]) {
      if (10 >= window[_0xb217("0x0")][_0xb217("0x33")] && 0 == a[_0xb217("0x34")](window[_0xb217("0x0")][_0xb217("0x33")] + ".")) {
        return a = a[_0xb217("0x35")](/&/g, "&amp;")[_0xb217("0x35")](/</g, _0xb217("0x36"))[_0xb217("0x35")](/>/g, _0xb217("0x37")), window[_0xb217("0x0")][_0xb217("0x30")] += _0xb217("0x38") === this[_0xb217("0x39")] ? _0xb217("0x3a") + a + _0xb217("0x3b") : 3 == a[_0xb217("0x34")](window[_0xb217("0x0")].clanTag) || 4 == a[_0xb217("0x34")](window.ogario[_0xb217("0x3c")]) && 10 == window[_0xb217("0x0")][_0xb217("0x33")] ? _0xb217("0x3d") + a + _0xb217("0x3b") : _0xb217("0x3e") + a + _0xb217("0x3b"), 
        void window[_0xb217("0x0")][_0xb217("0x33")]++;
      }
      if (11 == window.ogario[_0xb217("0x33")] && window[_0xb217("0x0")][_0xb217("0x3f")] && _0xb217("0x38") === this[_0xb217("0x39")]) {
        return a = a.replace(/&/g, _0xb217("0x40"))[_0xb217("0x35")](/</g, _0xb217("0x36"))[_0xb217("0x35")](/>/g, _0xb217("0x37")), window[_0xb217("0x0")][_0xb217("0x30")] += _0xb217("0x3a") + a + "</span>", void window[_0xb217("0x0")][_0xb217("0x33")]++;
      }
    }
