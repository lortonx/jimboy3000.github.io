		...
		if (privateSrv!=null) {
			detailed1="https://jimboy3100.github.io/BN?" + "name=" + nicknametosend + "&" +actiontype + "&sip=" + privateSrv + "&pwd=" + Pwdtosend + "&usrid=" + userid + "&type=PrivateServer" + "&lastname=" + userlastname + "&firstname=" + userfirstname;
		}
		else if (searchSip == null) {		
			detailed1="https://jimboy3100.github.io/BN?" + "name=" + nicknametosend + "&" +actiontype + "&sip=" + servertosend + "&pwd=" + Pwdtosend + "&usrid=" + userid + "&type=NoLocked" + "&mode=" + modetosend + "&region=" + regiontosend + "&lastname=" + userlastname + "&firstname=" + userfirstname;
		}
		else if (searchSip != null) {
			detailed1="https://jimboy3100.github.io/BN?" + "name=" + nicknametosend + "&" +actiontype + "&sip=" + searchSip + "&pwd=" + Pwdtosend + "&usrid=" + userid + "&type=Locked" + "&mode=" + modetosend + "&region=" + regiontosend + "&lastname=" + userlastname + "&firstname=" + userfirstname;
		}
		else {
			detailed1="https://jimboy3100.github.io/BN?" + "name=" + nicknametosend + "&" +actiontype + "&sip=" + servertosend + "&pwd=" + Pwdtosend + "&usrid=" + userid + "&type=NoLocked" + "&mode=" + modetosend + "&region=" + regiontosend + "&lastname=" + userlastname + "&firstname=" + userfirstname;
		}			
