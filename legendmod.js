...
/*	
	...
	$(".menu-tabs").children().last().after('<li class="legend-tab" onclick=legendtab(); style="width: 14.27%; height: 100%;" data-toggle="tooltip" data-title="Tools" data-placement="top"><a style="height: 100%;" class="fa fa-cogs"></a></li>');
