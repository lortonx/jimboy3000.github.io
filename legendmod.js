/*************
* LEGEND modv2.052 by Jimboy3100   email:jimboy3100@hotmail.com
*************/
...
(function(a, c) {
    function r(a, d) {
		...
		$(function() {
			$("#gamemode").after('<input id="server" class="form-control" style="width: 73%;  display: inline-block; margin-right: 0px margin-top: 3px"><button type="submit" id="connect" class="btn btn-primary" style="width: 24%; display: inline-block; margin-left: 5px">Connect</button>');
