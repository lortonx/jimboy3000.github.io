...
//        localStorage.setItem("gamemode", ogario.gameMode);});
	...
	'<button id="RotateLeft" class="btn-link" style="padding: 0px;color: #d6d3d3; width: 49%;height: 100%;" onclick="rotateminimapsectors2();" data-toggle="tooltip" data-original-title="Rotate Minimap Sectors Left"><i class="fa fa-undo" style="padding-left: 0px;"></i></button>'+
	'<button id="RotateRight" class="btn-link" style="padding: 0px; color: #d6d3d3; width: 49%; height: 100%;" onclick="rotateminimapsectors();" data-toggle="tooltip" data-original-title="Rotate Minimap Sectors Right"><i class="fa fa-repeat" style="padding-left: 0px;"></i></button></div>');
