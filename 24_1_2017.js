...
// @namespace    ogario.v2
// @version      1.8
// @description  OGARio - Legend mod v1.0
// @homepage     http://www.legendmod.ml
// @author       Jimboy3100/Smyzy
...
// Legend Mod by Jimboy3100 (www.legendmod.ml)
...
function inject(page) {
    var page = page.replace("</head>", cpickerCSS + toastrCSS + switchCSS + rangeCSS + perfectCSS + ogarioCSS + faCSS + cpickerJS + toastrJS + switchJS + rangeJS + perfectJS + ogarioSniffJS + ytJS + "</head>");
